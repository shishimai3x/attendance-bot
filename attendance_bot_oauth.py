#!/usr/bin/env python3
"""
GitHub Actions用 勤怠お知らせBot（個人認証版）
...
class AttendanceBotOAuth:
    """GitHub Actions用勤怠Bot（個人認証版）"""
    ...
    def authenticate(self):
        ...
        try:
            ...
            print("Google Sheets API認証成功（個人認証）")
            return service
