...
class AttendanceBotGitHub:
    """GitHub Actions用勤怠Bot"""
    ...
    def __init__(self):
        ...
        # Google Sheets API認証（サービスアカウントキーを使用）
    ...
    def authenticate(self):
        ...
        try:
            ...
            if not service_account_info:
                raise Exception("GOOGLE_SERVICE_ACCOUNT_KEY環境変数が設定されていません")
